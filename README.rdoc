...
Adwords client library that works with ruby 1.9 and 1.8.
...
It uses patron (http://github.com/toland/patron) as http client.
Patron is not available on all platform. I plan to degrade to another http client
when patron is not installed.
...
Copyright (c) 2009 Giovanni Ferro. See LICENSE for details.
